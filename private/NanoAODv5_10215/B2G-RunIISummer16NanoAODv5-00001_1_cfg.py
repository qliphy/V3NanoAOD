...
# with command line options: step1 --filein file:1.root --fileout file:B2G-RunIISummer16NanoAODv5-00001.root --mc --eventcontent NANOEDMAODSIM --datatier NANOAODSIM --conditions 102X_mcRun2_asymptotic_v7 --step NANO --nThreads 2 --era Run2_2016,run2_nanoAOD_94X2016 --python_filename B2G-RunIISummer16NanoAODv5-00001_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 100
...
#process.NANOEDMAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:B2G-RunIISummer16NanoAODv5-00001.root'),
    outputCommands = process.NANOAODSIMEventContent.outputCommands
)
process.NANOEDMAODSIMoutput.fakeNameForCrab=cms.untracked.bool(True)
